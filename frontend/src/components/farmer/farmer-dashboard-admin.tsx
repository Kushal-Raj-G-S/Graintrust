...
export function FarmerDashboardAdmin(): React.JSX.Element {
  ...
  const handleViewBatch = (batch: BatchData): void => {
    ...
    if (batch.certificate_id && batch.qrCode) {
      generateQRCode(batch.qrCode);
    } else {
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        {/* AI Validation Dashboard Button */}
        <Button
          onClick={() => router.push('/admin/ai-validation')}
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* QR Code Section - ONLY show if blockchain generated certificate */}
                  ...
                  {selectedBatch.certificate_id && selectedBatch.qrCode && qrCodeImage && (
                    <div>
                      <h4 className="font-semibold mb-3 text-lg">🎉 Blockchain Certificate QR Code</h4>
